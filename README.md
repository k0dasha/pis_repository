...
- Руководство по запуску тестов:
  ...
  2. Развернуть решение проекта
  3. Открыть слой с модульными тестами для просмотра(UnitTests)
  4. Правой кнопкой мыши нажать на слой с тестами и выбрать вариант "Выполнить тесты"
  5. В открывшемся окне Обозревателя тестов проверить корректность выполнения всех модульных тестов
